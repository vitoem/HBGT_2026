...
> Este programa fue generado a partir del contenido publicado en `docs/programa.md` y en cada una de las páginas `docs/dia-01.md` a `docs/dia-11.md` del repositorio del curso. Los días 10 y 11 (Metagenómica) aún no cuentan con materiales publicados al momento de generar este documento — se indican como pendientes.
>
> La columna **Responsable** se deja en blanco para que el equipo de instructores la complete según corresponda.
...
| **10** | Martes 30 sept | Metagenómica I | Introducción al análisis de datos metagenómicos y flujo de trabajo. *(Materiales pendientes de publicación por parte de la coordinación del curso)* | Pendiente de publicar | |
| **11** | Jueves 1 oct | Metagenómica II y cierre del curso | Continuación del análisis metagenómico, evaluación final y cierre del curso. *(Materiales pendientes de publicación por parte de la coordinación del curso)* | Pendiente de publicar / Evaluación final | |
